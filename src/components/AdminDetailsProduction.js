    ...
    return (
        <div className="container mt-5">
            ...
            <div className="box">
                ...
                <button type="button" onClick={(e) => { e.preventDefault(); navigate("/admin/production/"); }} className='button is-danger mr-5'>Kembali</button>
            </div>
        </div>
    );
};

export default AdminDetailsProduction;
