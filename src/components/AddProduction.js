...
const AddProduction = () => {
    ...
    axiosJWT.interceptors.request.use (async(config)=>{
      ...
      const saveProduction = async (e) => {
        e.preventDefault();
        try {
          await axiosJWT.post(`${process.env.REACT_APP_API_URL}uploadproduction`, {
            kategori,
            mesin,
            jenisproduk,
            namaproduk,
    ...
    const addDetailsLabel = () => {
        setDetails([...details, { detaillabel1: "", detaillabel2: "", detaillabel3: "", operator: "", jam: "", shift: "",tonase_label1: "", tonase_label2: "", tonase_label3: "",karung1:"",  karung2:"", karung3:"" }]);
    };
...
const validateKeterangan = () => {
    ...
    const isValid = kategori && mesin && jenisproduk && namaproduk && labelumum && supervisor && operator1 && operator2 && operator3 && tanggal  && tonase  && details.every(detail => detail.detaillabel1 && detail.detaillabel2 && detail.detaillabel3 && detail.operator && detail.jam );
  ...
  <div className="field">
    ...
    {errorKeterangan && <p className="help is-danger">{errorKeterangan}</p>}
                                ...
                                <div key={index} className="box">
                                    ...
                                    <div className="columns">
                                        <div className="column">
                                            ...
                                            <input type="number" className="input" value={detail.tonase_label1= detail.karung1 * tonaseMultipliers[namaproduk] || 0} readOnly required />
                                        </div>
                                        <div className="column">
                                            <label className="label">Tonase</label>
                                            <input type="number" className="input" value={detail.tonase_label2= detail.karung2 * tonaseMultipliers[namaproduk] || 0} readOnly required />
                                        </div>
                                        <div className="column">
                                            <label className="label">Tonase</label>
                                            <input type="number" className="input"  value={detail.tonase_label3= detail.karung3 * tonaseMultipliers[namaproduk] || 0}readOnly required />
                                        </div>
                                        <div className="column">
                ...
                <button type='button' onClick={() => navigate("/production/")} className='button is-danger mr-5'>Kembali</button>
